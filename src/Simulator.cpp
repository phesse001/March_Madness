...
void run(int home_field_advantage, bool apply_scaling){
    createTeams(string("/workspace/madness/data/NCAABasketballTeams.txt"));
    loadGames(string("/workspace/madness/data/NCAABasketballGames.txt"), home_field_advantage, apply_scaling);
